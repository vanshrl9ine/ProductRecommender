    ...
    if submit:
        ...
        if user_location:
            ...
            if location:
                ...
                db.child("users").child(user['localId']).child("user_locations").push(location_data)
    ...
    def func():
        ...
        if st.button('Recommend'):
            if selected_pid:
                ...
                db.child("users").child(st.session_state.user['localId']).child("user_searches").push(search_data)
